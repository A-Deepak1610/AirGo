...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white text-slate-800 flex flex-col h-screen sticky top-0 border-r border-slate-200 select-none z-30 shrink-0 font-sans">
      ...
      {/* Navigation Items (Without 'NAVIGATION' or 'Public Portal & APIx' headings) */}
      <div className="flex-1 overflow-y-auto py-4 px-3.5 space-y-1 scrollbar-none">
            ...
            {section.items.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-[13px] transition-all cursor-pointer ${
                    isActive
